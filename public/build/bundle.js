...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 167, 2, 4583);
    			attr_dev(section0, "class", "green-box svelte-1oz65pl");
    			add_location(section0, file$5, 166, 1, 4552);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle0, file$3, 2, 8, 51);
    			...
    			add_location(circle1, file$3, 3, 8, 163);
    			attr_dev(svg, "class", "svelte-18zoxxb");
    			add_location(svg, file$3, 1, 4, 36);
    			add_location(p, file$3, 5, 4, 284);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-19ry43x");
    			add_location(div, file$2, 18, 4, 536);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$3(ctx) {
    	...
    	iconicbutton.$on("click", /*click_handler*/ ctx[1]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ UnderDevelopment });
    	return [];
    }
