...
var app = (function () {
    ...
    const file$6 = "src\\components\\buttons\\IconicButton.svelte";
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<IconicButton> was created with unknown prop '${key}'`);
    	});
    ...
    class IconicButton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { icon_class: 0, text: 1, style: 2 });
    		...
    		if (/*icon_class*/ ctx[0] === undefined && !("icon_class" in props)) {
    			console_1.warn("<IconicButton> was created without expected prop 'icon_class'");
    		}

    		if (/*text*/ ctx[1] === undefined && !("text" in props)) {
    			console_1.warn("<IconicButton> was created without expected prop 'text'");
    		}

    		if (/*style*/ ctx[2] === undefined && !("style" in props)) {
    			console_1.warn("<IconicButton> was created without expected prop 'style'");
    		}
    	}
    ...
    const file$5 = "src\\components\\icons\\SoroushIcon.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$5, 1, 251, 273);
    			...
    			add_location(path1, file$5, 1, 644, 666);
    			add_location(g, file$5, 1, 231, 253);
    ...
    const file$4 = "src\\components\\icons\\RubikaIcon.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$4, 1, 249, 271);
    			add_location(g, file$4, 1, 237, 259);
    			attr_dev(svg, "version", "1.1");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "xmlns:xlink", "http://www.w3.org/1999/xlink");
    			attr_dev(svg, "x", "0px");
    			...
    			attr_dev(svg, "xml:space", "preserve");
    			add_location(svg, file$4, 1, 4, 26);
    			attr_dev(div, "class", "p-icon");
    ...
    const file$3 = "src\\components\\icons\\VirgoolIcon.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(feGaussianBlur, file$3, 9, 4, 485);
    			...
    			add_location(feColorMatrix, file$3, 10, 4, 593);
    			...
    			add_location(linearGradient, file$3, 12, 4, 737);
    			...
    			add_location(path0, file$3, 16, 4, 1081);
    			...
    			add_location(path1, file$3, 21, 4, 1672);
    			attr_dev(g0, "class", "st1");
    			add_location(g0, file$3, 20, 4, 1651);
    			...
    			add_location(path2, file$3, 26, 4, 2054);
    			add_location(g1, file$3, 25, 4, 2045);
    ...
    const file$2 = "src\\components\\static\\Biography.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 1, 0, 38);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$1 = "src\\components\\cards\\SkillCard.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$1, 7, 4, 200);
    			attr_dev(footer, "class", "svelte-1q04dzj");
    			add_location(footer, file$1, 10, 4, 273);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { vectorImg = "" } = $$props;
    	const writable_props = ["vectorImg"];
    	...
    	$$self.$capture_state = () => ({ IconicButton, vectorImg });
    	...
    	return [vectorImg, $$scope, slots];
    }

    class SkillCard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { vectorImg: 0 });
    ...
    function create_body_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h3 = element("h3");
    			h3.textContent = "توسعه Front-end";
    			attr_dev(h3, "align", "center");
    			attr_dev(h3, "class", "card-header svelte-wlaj5f");
    			add_location(h3, file, 108, 6, 2627);
    			attr_dev(section, "slot", "body");
    			add_location(section, file, 107, 5, 2598);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_body_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h3, "align", "center");
    			attr_dev(h3, "class", "card-header svelte-wlaj5f");
    			add_location(h3, file, 115, 6, 2839);
    			attr_dev(section, "slot", "body");
    			add_location(section, file, 114, 5, 2810);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    			append_dev(section, h3);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 65, 3, 1439);
    			attr_dev(div0, "class", "user-profile svelte-wlaj5f");
    			add_location(div0, file, 64, 2, 1408);
    			attr_dev(span0, "id", "s-icon");
    			set_style(span0, "transform", "translateX(50px)");
    			attr_dev(span0, "class", "svelte-wlaj5f");
    			add_location(span0, file, 68, 3, 1522);
    			attr_dev(span1, "id", "v-icon");
    			attr_dev(span1, "class", "svelte-wlaj5f");
    			add_location(span1, file, 71, 3, 1615);
    			attr_dev(span2, "id", "r-icon");
    			set_style(span2, "transform", "translateX(-50px)");
    			attr_dev(span2, "class", "svelte-wlaj5f");
    			add_location(span2, file, 74, 3, 1671);
    			attr_dev(div1, "class", "link-list svelte-wlaj5f");
    			add_location(div1, file, 67, 2, 1494);
    			attr_dev(h10, "class", "title svelte-wlaj5f");
    			add_location(h10, file, 78, 2, 1773);
    			attr_dev(p, "class", "description svelte-wlaj5f");
    			add_location(p, file, 81, 2, 1820);
    			attr_dev(div2, "class", "btn-group svelte-wlaj5f");
    			add_location(div2, file, 84, 2, 1910);
    			attr_dev(header, "class", "header svelte-wlaj5f");
    			add_location(header, file, 63, 1, 1381);
    			attr_dev(div3, "class", "container rtl svelte-wlaj5f");
    			add_location(div3, file, 92, 2, 2287);
    			attr_dev(section0, "class", "green-box svelte-wlaj5f");
    			add_location(section0, file, 91, 1, 2256);
    			attr_dev(div4, "class", "main-grid svelte-wlaj5f");
    			add_location(div4, file, 62, 0, 1355);
    			attr_dev(h11, "align", "center");
    			attr_dev(h11, "class", "svelte-wlaj5f");
    			add_location(h11, file, 99, 1, 2379);
    			add_location(section1, file, 98, 0, 2367);
    			...
    			add_location(div5, file, 103, 1, 2462);
    			attr_dev(div6, "class", "splide");
    			add_location(div6, file, 102, 0, 2439);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(soroushicon, span0, null);
    			append_dev(div1, t1);
    			append_dev(div1, span1);
    			mount_component(virgoolicon, span1, null);
    			append_dev(div1, t2);
    			append_dev(div1, span2);
    			mount_component(rubikaicon, span2, null);
    			...
    			mount_component(biography, div3, null);
    		...
    		p: function update(ctx, [dirty]) {
    			const skillcard0_changes = {};

    			if (dirty & /*$$scope*/ 8) {
    				skillcard0_changes.$$scope = { dirty, ctx };
    			}

    			skillcard0.$set(skillcard0_changes);
    			const skillcard1_changes = {};

    			if (dirty & /*$$scope*/ 8) {
    				skillcard1_changes.$$scope = { dirty, ctx };
    			}
