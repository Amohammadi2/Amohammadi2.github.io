...
var app = (function () {
    ...
    class IconicButton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$e, create_fragment$e, safe_not_equal, { icon_class: 0, text: 1, style: 2 });
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$7, 163, 2, 4372);
    			attr_dev(section0, "class", "green-box svelte-16o8xqp");
    			add_location(section0, file$7, 162, 1, 4341);
    ...
    // (31:1) {#each $notifications as n (n.pk)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file, 31, 2, 890);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(31:1) {#each $notifications as n (n.pk)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 29, 0, 819);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const routes = {
    		...
    		"/m_loader": wrap$1({ ...cm_wrap_opts, component: Loader })
    	};
