...
var app = (function () {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<IconicButton> was created with unknown prop '${key}'`);
    	});
    ...
    class IconicButton extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*icon_class*/ ctx[0] === undefined && !("icon_class" in props)) {
    			console_1$1.warn("<IconicButton> was created without expected prop 'icon_class'");
    		}

    		if (/*text*/ ctx[1] === undefined && !("text" in props)) {
    			console_1$1.warn("<IconicButton> was created without expected prop 'text'");
    		}

    		if (/*style*/ ctx[2] === undefined && !("style" in props)) {
    			console_1$1.warn("<IconicButton> was created without expected prop 'style'");
    		}
    	}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Link> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ addr, action, cpy_field, copy });
    ...
    // (72:3) <Link addr="@ashkan_mohammadi" action="copy">
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 72, 4, 1764);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(72:3) <Link addr=\\\"@ashkan_mohammadi\\\" action=\\\"copy\\\">",
    		ctx
    	});
    ...
    // (77:3) <Link addr="https://virgool.io/@mohammadiashkan1384">
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-vm8z03");
    			add_location(span, file, 77, 4, 1930);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(77:3) <Link addr=\\\"https://virgool.io/@mohammadiashkan1384\\\">",
    		ctx
    	});
    ...
    // (82:3) <Link addr="@m_AshkanProgrammer" action="copy">
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(span, "transform", "translateX(-50px)");
    			attr_dev(span, "class", "svelte-vm8z03");
    			add_location(span, file, 82, 4, 2053);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(82:3) <Link addr=\\\"@m_AshkanProgrammer\\\" action=\\\"copy\\\">",
    		ctx
    	});
