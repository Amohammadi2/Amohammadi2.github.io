...
var app = (function () {
    ...
    const file$f = "src\\routes\\Loader.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle0, file$f, 23, 12, 623);
    			...
    			add_location(circle1, file$f, 24, 12, 739);
    			attr_dev(svg, "class", "svelte-18zoxxb");
    			add_location(svg, file$f, 22, 8, 604);
    			add_location(p, file$f, 26, 8, 868);
    			attr_dev(div, "class", "loader-container svelte-18zoxxb");
    			add_location(div, file$f, 21, 4, 537);
    		},
    		m: function mount(target, anchor) {
    ...
    class Loader extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$f, create_fragment$f, safe_not_equal, { autoFadeOut: 1, duration: 2, loading: 0 });
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$e, 16, 4, 352);
    			add_location(span1, file$e, 17, 4, 432);
    			attr_dev(div0, "class", "not-progress svelte-16o6css");
    			add_location(div0, file$e, 18, 4, 458);
    			attr_dev(div1, "class", div1_class_value = "notification " + /*type*/ ctx[1] + " svelte-16o6css");
    			add_location(div1, file$e, 15, 0, 313);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Notification extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$e, create_fragment$e, safe_not_equal, { msg: 0, type: 1, pk: 2 });
    ...
    const file$d = "src\\components\\buttons\\IconicButton.svelte";
    ...
    class IconicButton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$d, create_fragment$d, safe_not_equal, { icon_class: 0, text: 1, style: 2 });
    ...
    const file$c = "src\\components\\icons\\SoroushIcon.svelte";
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$c, 1, 251, 273);
    			...
    			add_location(path1, file$c, 1, 644, 666);
    			add_location(g, file$c, 1, 231, 253);
    ...
    const file$b = "src\\components\\icons\\RubikaIcon.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$b, 1, 249, 271);
    			add_location(g, file$b, 1, 237, 259);
    			attr_dev(svg, "version", "1.1");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "xmlns:xlink", "http://www.w3.org/1999/xlink");
    			attr_dev(svg, "x", "0px");
    ...
    const file$a = "src\\components\\icons\\VirgoolIcon.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(feGaussianBlur, file$a, 9, 4, 485);
    			...
    			add_location(feColorMatrix, file$a, 10, 4, 593);
    			...
    			add_location(linearGradient, file$a, 12, 4, 737);
    			...
    			add_location(path0, file$a, 16, 4, 1081);
    			...
    			add_location(path1, file$a, 21, 4, 1672);
    			attr_dev(g0, "class", "st1");
    			add_location(g0, file$a, 20, 4, 1651);
    			...
    			add_location(path2, file$a, 26, 4, 2054);
    			add_location(g1, file$a, 25, 4, 2045);
    ...
    const file$9 = "src\\components\\static\\Biography.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$9, 1, 0, 38);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$8 = "src\\components\\cards\\SkillCard.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$8, 7, 4, 175);
    			attr_dev(main, "class", "body");
    			add_location(main, file$8, 8, 4, 226);
    			attr_dev(footer, "class", "svelte-1l5uh0p");
    			add_location(footer, file$8, 11, 4, 299);
    			attr_dev(div, "class", "skill-card svelte-1l5uh0p");
    			add_location(div, file$8, 6, 0, 145);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class SkillCard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { vectorImg: 0, text: 1 });
    ...
    const file$7 = "src\\components\\utils\\Link.svelte";
    ...
    class Link extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { addr: 0, action: 1 });
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$6, 131, 5, 3313);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    ...
    function create_default_slot_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-16o8xqp");
    			add_location(span, file$6, 136, 5, 3484);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(span, "transform", "translateX(-50px)");
    			attr_dev(span, "class", "svelte-16o8xqp");
    			add_location(span, file$6, 141, 5, 3612);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    ...
    const file$5 = "src\\components\\icons\\GenericIcon.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$5, 8, 8, 151);
    			attr_dev(div0, "class", "img svelte-6sq03z");
    			add_location(div0, file$5, 7, 4, 124);
    			attr_dev(div1, "class", "text");
    			add_location(div1, file$5, 10, 4, 241);
    			attr_dev(div2, "class", "icon svelte-6sq03z");
    			add_location(div2, file$5, 6, 0, 100);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class GenericIcon extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { icon: 0, text: 1, iconWidth: 2 });
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ isProduction, post_img, production });
